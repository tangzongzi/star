      ...
      <div class="relative bg-white rounded-2xl shadow-xl overflow-hidden">
        ...
        <div class="px-6 py-4 bg-gradient-to-r from-indigo-500 to-purple-600">
          <div class="flex items-center justify-between">
            <h2 class="text-xl font-semibold text-white">添加新任务</h2>
            <button 
              @click="$emit('close')"
        ...
        <div class="p-6">
          <form @submit.prevent="handleSubmit" class="space-y-6">
            <div class="space-y-4">
              <div class="form-group">
                ...
                <input
                  ...
                  v-model="form.title"
                  type="text"
                  class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-colors"
                  placeholder="例如：整理房间"
                  required
                />
              </div>
              ...
              <div class="form-group">
                ...
                <textarea
                  ...
                  class="w-full px-4 py-2.5 rounded-lg border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-colors min-h-[120px] resize-none"
              ...
              <div class="grid grid-cols-2 gap-4">
                <div class="form-group">
                  ...
                  <div class="relative">
                    <input
                      ...
                      type="number"
                      min="1"
                      class="w-full pl-4 pr-10 py-2.5 rounded-lg border border-gray-200 focus:border-indigo-500 focus:ring-2 focus:ring-indigo-200 transition-colors"
                      required
                    />
                ...
                <div class="form-group">
                  <label class="block text-sm font-medium text-gray-700 mb-1" for="deadline">
                    截止日期
                  </label>
                  <div class="relative">
                    <input
            ...
            <div class="flex items-center justify-end space-x-4 pt-4 border-t border-gray-100">
              ...
              <button 
                type="submit"
                class="px-4 py-2 rounded-lg bg-gradient-to-r from-indigo-600 to-purple-600 text-white text-sm font-medium hover:from-indigo-700 hover:to-purple-700 transition-all duration-200 shadow-sm hover:shadow focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
              >
                添加任务
              </button>
            </div>
